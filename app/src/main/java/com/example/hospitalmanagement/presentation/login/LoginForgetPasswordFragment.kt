 ...
 * Use the [LoginForgetPasswordFragment.newInstance] factory method to
...
class LoginForgetPasswordFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment LoginForgetPasswordFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            LoginForgetPasswordFragment().apply {
